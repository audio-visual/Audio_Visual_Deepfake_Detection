...
@register_meta_arch("AVLocPointTransformerRecoveryNoNormNorecon")
class AVPtTransformerRecovery(nn.Module):
    ...
    def forward(self, video_list):
        ...
        norm_inputs,_, cls_scores = self.interpolator(batched_inputs, batched_masks)
